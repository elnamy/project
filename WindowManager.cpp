...
WindowManager::WindowManager() {
    if (instance) {
        std::cerr << "One instance of WindowManager has already been created, "
                     "event callbacks of new instance will not work."
                  << std::endl;
    }
...
GLFWwindow *WindowManager::getHandle() { return windowHandle; }
...
void WindowManager::mouse_callback(GLFWwindow *window, int button, int action,
                                   int mods) {
    if (instance && instance->callbacks) {
...
void WindowManager::resize_callback(GLFWwindow *window, int in_width,
                                    int in_height) {
    if (instance && instance->callbacks) {
...
void WindowManager::scroll_callback(GLFWwindow *window, double in_deltaX,
                                    double in_deltaY) {
    if (instance && instance->callbacks) {
...
void WindowManager::cursor_callback(GLFWwindow *window, double xpos,
                                    double ypos) {
    if (instance && instance->callbacks) {
